...
public class Vision extends SubsystemBase {
  ...
  private final Transform3d robotToCam =
      new Transform3d(
          new Translation3d(0.0, Units.inchesToMeters(10), Units.inchesToMeters(-3)),
          new Rotation3d(0, 0, 0));

  private final HttpCamera camera =
      new HttpCamera(
          "limelight",
          "http://photonvision.local:1182/stream.mjpg?1675300761194",
  ...
  private final AprilTagFieldLayout fieldLayout2023 =
      new AprilTagFieldLayout(aprilTags, 16.54, 8.02);
  ...
  public Vision() {
    ...
    robotPoseEstimator =
        new PhotonPoseEstimator(
            fieldLayout2023, PoseStrategy.AVERAGE_BEST_TARGETS, photon, robotToCam);
